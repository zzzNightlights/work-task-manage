...
(function e(t, n, r) {
      ...
      (function(global) {
        ...
        var definePinchZoom = function($) {
          ...
          PinchZoom.prototype = {
            ...
            /**
             * Updates the img values according to the current zoom factor and offset
             */
            update: function() {
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        var Progress = (function() {
          ...
          /**
           * (Internal) Applies img properties to an element, similar to the jQuery
           * img method.
           *
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        Share.SNS = {
          ...
          qq: {
            title: 'QQ 好友',
            url: 'http://connect.qq.com/widget/shareqq/area-list.html',
            icon: 'qq'
          },
          // url:,
          // title:'',    分享标题(可选)
  ...
  41: [
    function(require, module, exports) {
     ...
     img({top: $(window).height() - offsetBottom - this.offset.height});
     } else {
     $element.removeClass(options.className.stickyBtm).img({top: offsetTop});
     }
     }
     */
          }
  ...
  46: [
    function(require, module, exports) {
      (function(global) {
        ...
        /**
         * add/remove the img properties as defined in manager.options.cssProps
         * @param {Manager} manager
         * @param {Boolean} add
         */
